...
export default function Blog() {
  ...
  return <Shell><main className="mx-auto max-w-6xl px-5 py-14 sm:py-20">
    ...
    {!lead ? <Card className="mt-6 p-10 text-center"><p className="font-serif text-2xl text-white/75">The newsroom is quiet.</p><p className="mt-2 text-sm text-white/35">New stories will appear here as they are published.</p></Card> : <>
