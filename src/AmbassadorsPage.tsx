    ...
    <div className="min-h-screen overflow-hidden bg-[#050505] text-white selection:bg-white selection:text-black">
      ...
      <main>
        ...
        <section id="partners" className="border-y border-white/10 bg-[#090909] px-5 py-20 sm:px-8 sm:py-28">
          <div className="mx-auto max-w-[1480px] text-center"><p className="text-[10px] font-bold uppercase tracking-[.3em] text-[#ff6a1f]">The BitBuzz network</p><h2 className="mt-4 font-serif text-5xl font-black tracking-[-.055em] sm:text-7xl">See our partners.</h2><p className="mx-auto mt-5 max-w-2xl text-sm leading-6 text-white/38 sm:text-base">Schools, clubs and organizations that are officially part of the BitBuzz Ambassador network will be showcased here with their identity and logo. The wall grows as the network grows.</p><div className="mx-auto mt-14 grid max-w-5xl grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4"><div className="col-span-2 flex min-h-[180px] items-center justify-center rounded-[26px] border border-dashed border-white/10 bg-[#050505] p-8 sm:col-span-3 lg:col-span-4"><div><p className="text-[10px] font-bold uppercase tracking-[.22em] text-white/25">Partner wall</p><p className="mt-3 font-serif text-3xl font-black tracking-[-.04em] text-white/70 sm:text-4xl">Built with communities.</p><p className="mx-auto mt-3 max-w-lg text-xs leading-5 text-white/25">Partner logos will appear here once their Ambassador profiles are approved and published.</p></div></div></div></div>
        </section>

        <section className="px-5 py-20 sm:px-8 sm:py-28"><div className="mx-auto max-w-[1480px] rounded-[32px] border border-[#ff6a1f]/35 bg-[#0b0b0b] px-7 py-14 text-center shadow-[0_0_100px_rgba(255,91,31,.07)] sm:px-12 sm:py-20"><p className="text-[10px] font-bold uppercase tracking-[.3em] text-[#ff6a1f]">Ambassadors</p><h2 className="mx-auto mt-5 max-w-4xl font-serif text-5xl font-black leading-[.86] tracking-[-.06em] sm:text-8xl">Make your community impossible to miss.</h2><p className="mx-auto mt-7 max-w-2xl text-sm leading-6 text-white/38 sm:text-base">A dedicated publication space. A place for your stories. A newsletter for your audience. Built on BitBuzz.</p></div></section>
      </main>
    </div>
  );
}
