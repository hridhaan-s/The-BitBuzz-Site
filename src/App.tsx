  ...
  return (
    <div className="min-h-[100dvh] bg-black text-ink">
      ...
      <main id="main-content" className="mx-auto max-w-[1440px] px-4 pb-20 sm:px-6 lg:px-8">
        <section className="relative isolate min-h-[560px] overflow-hidden border-b border-line py-10 sm:min-h-[620px] sm:py-14 lg:min-h-[680px] lg:py-16">
          <img src={HERO_GIF} alt="" aria-hidden="true" className="pointer-events-none absolute inset-0 z-[-2] h-full w-full object-cover opacity-30" />
          <div className="pointer-events-none absolute inset-0 z-[-1] bg-[linear-gradient(90deg,#000000_0%,rgba(0,0,0,.88)_34%,rgba(0,0,0,.68)_65%,rgba(0,0,0,.82)_100%)]" />
          <div className="pointer-events-none absolute inset-0 z-[-1] bg-[radial-gradient(circle_at_78%_50%,rgba(93,152,255,.12),transparent_38%)]" />
          <div className="relative z-10 max-w-5xl pt-8 sm:pt-12 lg:pt-16">
            ...
            <h1 className="font-serif text-[clamp(3rem,8vw,7.5rem)] font-medium leading-[0.9] tracking-[-0.055em]">News worth<br /><em className="font-normal">knowing.</em></h1>
            <p className="mt-7 max-w-2xl text-[clamp(1rem,1.5vw,1.25rem)] leading-[1.5] text-soft">Science, technology and the ideas shaping tomorrow — reported for students, by students.</p>
          </div>
        </section>
